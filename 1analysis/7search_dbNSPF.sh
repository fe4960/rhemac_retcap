...
python ${shellPath}/bin/annotate_filter/pipeline_filter_and_annotate.dbNSFP_score_MutationAssessor.py -i $main/${file}.wHeader.vcf  -o $main/${file}.force_call.snp.anno.vcf -d ${file} -t SNP -f 1.1 -c 1 -s 1 -p
