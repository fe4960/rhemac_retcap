...
#monkey_table="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_new2_rm8_corrected_target_updated"
monkey_table="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_new2_rm8"
...
#			monkey_animial_id["uccap"][info[-1]]=info[1]
			monkey_id_check["uccap"][info[0]]=line1
			monkey_animial_id["uccap"][info[-1]]=info[0]



		else:
			monkey_id["retcap"][info[-1]]=line1
			monkey_id_check["retcap"][info[0]]=line1
			monkey_animial_id["retcap"][info[-1]]=info[0]
...
output="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_seq_coverage_new3_plat"

#output="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_seq_coverage"
ot=open(output,"w")
output1=f'{output}_rest'
ot1=open(output1,"w")
...
#PSC	0	11414-01b	369165	18088	41141	44784	14445	0	27.2	437
			...
			if info[2] in monkey_id["retcap"]:
				if monkey_animial_id["retcap"][info[2]] not in monkey_num:
					...
					monkey_num[monkey_animial_id["retcap"][info[2]]]["count"]+=1
					monkey_num[monkey_animial_id["retcap"][info[2]]]["type"]["retcap"]=1
				ot.write(f'{monkey_id["retcap"][info[2]]}\t{info[-2]}\tretcap\n')	
			else:
				ot1.write(f'{info[2]}\t{info[-2]}\tretcap\n')	
		...
		if re.search("^PSC",line):
			...
			if info1[0] in monkey_id["uccap"]:
				if monkey_animial_id["uccap"][info1[0]] not in monkey_num:
					...
					monkey_num[monkey_animial_id["uccap"][info1[0]]]["type"]["uccap"]=1
#				n+=1
				ot.write(f'{monkey_id["uccap"][info1[0]]}\t{info[-2]}\tuccap\n')	
			else:
				ot1.write(f'{info[2]}\t{info[-2]}\tuccap\n')	



new_cap="/storage/chen/home/jw29/monkey/data/retcap/genotypeGVCFs.3/snps/output.filtered.snps.removed.vep.stats.txt"
		...
		if re.search("^PSC",line):
			...
			if info1[1] in monkey_id["uccap"]:
				if monkey_animial_id["uccap"][info1[1]] not in monkey_num:
					...
					monkey_num[monkey_animial_id["uccap"][info1[1]]]["type"]["newcap"]=1
#                               n+=1
				ot.write(f'{monkey_id["uccap"][info1[1]]}\t{info[-5]}\tnewcap\n')
			else:
				ot1.write(f'{info[2]}\t{info[-5]}\tnewcap\n')
...
output1="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_seq_check_new3"
...
output2="/storage/chenlab/Users/junwang/monkey/data/retcap/monkey_table_retcap_seq_check_num_new3"
