...
my $var_file = "/storage/chenlab/Users/junwang/monkey/data/retcap/target_gene_with_var_new2_rm8_swiss_hg19AF"; #_50000_".$ARGV[0];
#my $temp = "ABCA4";
#my $temp = "PDE6B";
#my $temp = "$ARGV[0]";
my $temp = "mk_swiss_".$ARGV[0];
my $freq_cut = 10;
my $output = $var_file."_new_maxAF$freq_cut"."_mk";

open(OUTPUT,">$output") || die ("$output");

my $rhemac_mk="/storage/chenlab/Users/junwang/monkey/data/retcap/target_gene_with_var_new2_rm8_swiss_hg19AF_rhemac10_nt.fa";
